...
<body>
    ...
    <div class=" w3l-login-form">
        ...
        <form action="includes/login-hm.inc.php" method="POST">
            ...
            <button type="submit" name="login-submit"><a href="home_manager.php" >Login</a></button>
        </form>
    ...
    <footer>
        <p class="copyright-agileinfo">  2020 Project. All Rights Reserved | Design by <a href="https://www.linkedin.com/in/manisha-singh-5a88a4195/">Manisha Singh</a></p>
    </footer>
